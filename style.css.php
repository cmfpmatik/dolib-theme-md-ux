...
overflow-y: auto;
overflow-x: hidden;
background: #fff;padding-top: 33px;border-right: 1px solid rgba(0,0,0,0.3);
...
ul.tmenu {width: 100%;border-right: 1px solid rgba(0,0,0,0.3);
border-left: 1px solid rgba(0,0,0,0.3);background-color: #FFF;height: 150px;}
.login_block_other .login_block_elem a {padding-right: 1em !important;}
.side-nav-vert {top: 0;position: fixed;z-index: 150;width: 100%;height: 150px;overflow: hidden;}
#id-container {margin-top: 150px;margin-left: 0;}
}
